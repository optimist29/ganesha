...
function generatePageHTML(form) {
    const playlistUrl = `https://www.youtube.com/watch?v=OVIz8M8fva0&list=PLKXAZ7trxJgc-C_0x3iGfuicQN0K_QjRN&index=${form.playlistIndex}`;
        ...
        <div class="container">
            ...
            <div class="video-section">
                ...
                <div class="video-container">
                    <iframe 
                        src="https://www.youtube.com/embed/${form.videoId}?list=PLKXAZ7trxJgc-C_0x3iGfuicQN0K_QjRN&index=${form.playlistIndex}" 
                ...
                <div class="video-buttons">
                    <a href="${playlistUrl}" target="_blank" class="youtube-button">
                        Watch This Story on YouTube
                    </a>
                    <a href="https://www.youtube.com/@kathaswithpooja" target="_blank" class="youtube-button secondary">
